...
function editar(i){
    document.getElementById("nameUser").value = dadosLista[(i-1)]; // Pega o valor do campo que será editado
    dadosLista.splice(dadosLista[(i-1)], 1); // Remove o elemento do array
}